...
class DonorsControllerTest < ActionController::TestCase
  ...
  test "should create donor" do
    assert_difference('Donor.count') do
      post :create, donor: { cell: @donor.cell, donated_date: @donor.donated_date, email: @donor.email, gender: @donor.gender, name: @donor.name, subject: @donor.subject }
    end
  ...
  test "should update donor" do
    patch :update, id: @donor, donor: { cell: @donor.cell, donated_date: @donor.donated_date, email: @donor.email, gender: @donor.gender, name: @donor.name, subject: @donor.subject }
    assert_redirected_to donor_path(assigns(:donor))
  end
